...
`go-ruby-chronic/chronic` reimplements Ruby's `chronic` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-chronic/chronic` directly, with no Ruby runtime;
