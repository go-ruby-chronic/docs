# go-ruby-chronic documentation

**Pure-Go (CGO=0) MRI-faithful Ruby chronic**

`go-ruby-chronic/chronic` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `chronic`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `chronic`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-chronic/chronic
```
...
| Repo | What it is |
| --- | --- |
| [`chronic`](https://github.com/go-ruby-chronic/chronic) | the library — Ruby's `chronic` in pure Go |
| [`docs`](https://github.com/go-ruby-chronic/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-chronic.github.io`](https://github.com/go-ruby-chronic/go-ruby-chronic.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-chronic/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-chronic/chronic](https://github.com/go-ruby-chronic/chronic).
