...
The public API lives at the module root (`github.com/go-ruby-chronic/chronic`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `chronic`, while the surface follows
...
```go
import "github.com/go-ruby-chronic/chronic"
```
...
- **[pkg.go.dev/github.com/go-ruby-chronic/chronic](https://pkg.go.dev/github.com/go-ruby-chronic/chronic)**

The module's [README](https://github.com/go-ruby-chronic/chronic#readme) carries worked
