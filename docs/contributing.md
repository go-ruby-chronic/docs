...
Contributions are welcome. `go-ruby-chronic/chronic` is built to a small set of
...
The library is in [`github.com/go-ruby-chronic/chronic`](https://github.com/go-ruby-chronic/chronic).
This documentation site is in [`github.com/go-ruby-chronic/docs`](https://github.com/go-ruby-chronic/docs).
